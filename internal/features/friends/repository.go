...
type Notifier interface {
	FriendRequestReceived(ctx context.Context, authToken string, requestRow map[string]any)
	FriendRequestAccepted(ctx context.Context, authToken string, requestRow map[string]any)
}
